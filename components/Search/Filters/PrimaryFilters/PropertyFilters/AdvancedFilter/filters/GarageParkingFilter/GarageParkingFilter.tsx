...
export default function GarageParkingFilter() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-base font-semibold text-gray-800">Garage Parking</h3>
          <p className="text-sm text-gray-500">Set garage parking spaces range</p>
        </div>
      </div>
